...
export HF_HOME=/Users/jzl/.huggingface

# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
__conda_setup="$('/Users/jzl/miniforge3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
...
if [ -f "/Users/jzl/miniforge3/etc/profile.d/mamba.sh" ]; then
    . "/Users/jzl/miniforge3/etc/profile.d/mamba.sh"
fi
# <<< conda initialize <<<
